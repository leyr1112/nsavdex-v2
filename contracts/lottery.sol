...
contract NSBCLottery is ReentrancyGuard, INSBCLottery, Ownable {
    ...
    /**
     * @notice Set NSBC price ticket upper/lower limit
     * @dev Only callable by owner
     * @param _minPriceTicketInnsbc: minimum price of a ticket in NSBC
     * @param _maxPriceTicketInnsbc: maximum price of a ticket in NSBC
     */
