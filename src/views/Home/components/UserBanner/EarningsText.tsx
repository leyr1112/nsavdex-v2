...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and NSBC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and NSBC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from NSBC pool', data)
  }
